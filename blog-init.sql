/*
 PostgreSQL initialization script converted from the original MySQL schema.
*/
...
DROP TABLE IF EXISTS t_visitor CASCADE;
DROP TABLE IF EXISTS t_visit_log CASCADE;
DROP TABLE IF EXISTS t_visit_daily_stats CASCADE;
DROP TABLE IF EXISTS t_user_role CASCADE;
DROP TABLE IF EXISTS t_user_oauth CASCADE;
DROP TABLE IF EXISTS t_user CASCADE;
DROP TABLE IF EXISTS t_talk CASCADE;
DROP TABLE IF EXISTS t_tag CASCADE;
DROP TABLE IF EXISTS t_system_notice CASCADE;
DROP TABLE IF EXISTS t_role_menu CASCADE;
DROP TABLE IF EXISTS t_role_api CASCADE;
DROP TABLE IF EXISTS t_role CASCADE;
DROP TABLE IF EXISTS t_photo CASCADE;
DROP TABLE IF EXISTS t_page CASCADE;
DROP TABLE IF EXISTS t_operation_log CASCADE;
DROP TABLE IF EXISTS t_message CASCADE;
DROP TABLE IF EXISTS t_menu CASCADE;
DROP TABLE IF EXISTS t_login_log CASCADE;
DROP TABLE IF EXISTS t_friend CASCADE;
DROP TABLE IF EXISTS t_file_log CASCADE;
DROP TABLE IF EXISTS t_comment CASCADE;
DROP TABLE IF EXISTS t_article CASCADE;
DROP TABLE IF EXISTS t_api CASCADE;
