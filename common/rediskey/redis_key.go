...
func GetArticleLikeCountKey() string {
	return "blog:article:like_count"
}

// 评论点赞数排行
func GetCommentLikeCountKey() string {
	return "blog:comment:like_count"
}

// 说说点赞数排行
func GetTalkLikeCountKey() string {
	return "blog:talk:like_count"
}

// 文章访问量排行
func GetArticleViewCountKey() string {
	return "blog:article:view_count"
}
