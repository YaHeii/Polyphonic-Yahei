...
const (
	...
	MessageStatusEdited  = 1 // 编辑
	MessageStatusRecall  = 2 // 撤回
	MessageStatusDeleted = 3 // 删除

	// 留言审核状态 (is_review)
	MessageIsReviewNo  = 0 // 未审核通过
...
// 系统通知相关枚举 (t_system_notice)
const (
	// 通知发布状态 (publish_status)
	NoticeStatusDraft     = 1 // 草稿
	NoticeStatusPublished = 2 // 已发布
